...
### File: `src/components/ui/AppPasswordModal.tsx`
- **Exports**: AppPasswordModal
- **Local State**: password, step, q1, a1, q2, a2, q3, a3, confirmPassword
- **Hooks Used**: useState, useEffect
- **Store/Slices Read**: None
- **Repositories/Services Called**: '@src/services/appPasswordService'
- **Animations/Gestures**: Present (Reanimated/GestureHandler)
- **Summary**: /**  * Modal for creating, verifying, or removing an App Password.  */

---

### File: `src/services/appPasswordService.ts`
- **Exports**: isPasswordSet, setPassword, verifyPassword, getRecoveryQuestions, verifyRecoveryAnswers, removePassword
- **Local State**: None detected
- **Hooks Used**: None
- **Store/Slices Read**: None
- **Repositories/Services Called**: '@src/db/repositories/settingsRepository'
- **Summary**: /**  * App Password Service  * Manages a local app-level password with 3 recovery Q&A pairs.  */
